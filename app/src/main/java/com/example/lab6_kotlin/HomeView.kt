...
class HomeView : ViewModel() {
    private val inputDataGrindingMachine = MutableLiveData(Input(
        eta = 0.92,
        cos = 0.9,
        Un = 0.38,
        n = 4,
    ...
    private val inputDataGroutingMachine = MutableLiveData(Input(
        eta = 0.92,
        cos = 0.9,
        Un = 0.38,
        n = 2,
    ...
    private val inputDataCircularSaw = MutableLiveData(Input(
        eta = 0.92,
        cos = 0.9,
        Un = 0.38,
        n = 1,
    ...
    private val inputDataPress = MutableLiveData(Input(
        eta = 0.92,
        cos = 0.9,
        Un = 0.38,
        n = 1,
    ...
    private val inputDataPolishingMachine = MutableLiveData(Input(
        eta = 0.92,
        cos = 0.9,
        Un = 0.38,
        n = 1,
    ...
    private val inputDataShaper = MutableLiveData(Input(
        eta = 0.92,
        cos = 0.9,
        Un = 0.38,
        n = 2,
    ...
    private val inputDataFan = MutableLiveData(Input(
        eta = 0.92,
        cos = 0.9,
        Un = 0.38,
        n = 1,
